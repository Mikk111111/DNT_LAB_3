...
\begin{figure}[H]
    ...
    \caption{Užduočių seka daugiasluoksniam perceptronui mokyti ir modeliui išsaugoti}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Užduočių seka daugiasluoksniam perceptronui testuoti}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{KNIME_6.png}
    \caption{Užduočių seka daugiasluoksniam perceptronui mokyti ir testuoti}
\end{figure}
